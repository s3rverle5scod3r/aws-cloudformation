@echo off
rem This script will automatically deploy the stack in a stage environment: use this for a feature branch.
rem Parameters:
rem %1: Version (String) : The major, minor and subminor version of this deployment.
rem Execute usage: 'deploy_to_stage_stack.bat %1'
...
echo Deploying..
cmd /C call scripts/sam_command_stage.bat %1
